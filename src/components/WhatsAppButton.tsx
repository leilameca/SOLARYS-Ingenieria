...
export default function WhatsAppButton() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-5 right-5 z-50 flex h-16 w-16 items-center justify-center rounded-full border-4 border-white bg-[#25D366] shadow-xl shadow-emerald-500/30 hover:scale-105 hover:shadow-2xl"
    >
      <svg
        viewBox="0 0 32 32"
